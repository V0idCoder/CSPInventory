    ...
    public void export(List<Machine> machines, Path destination) {
        try (SXSSFWorkbook workbook = new SXSSFWorkbook(200)) {
            ...
            for (Machine machine : machines) {
                ...
                row.createCell(15).setCellValue(machine.getPurchaseDate() != null ? machine.getPurchaseDate().format(DATE_FORMATTER) : "");
                row.createCell(16).setCellValue(machine.getDateMiseEnService() != null ? machine.getDateMiseEnService().format(DATE_FORMATTER) : "");
                row.createCell(17).setCellValue(machine.getDateModif() != null ? machine.getDateModif().format(DATE_TIME_FORMATTER) : "");
            }
